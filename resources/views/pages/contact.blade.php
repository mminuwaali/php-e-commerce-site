...
@section('content')
    ...
    <section id="contact" class="flex flex-wrap w-full px-8">
        <form action="{{ route('contact') }}" method="post" class="flex flex-col grow-[3] basis-80 gap-8">
            @csrf
            ...
            <button class="border-2 border-black text-gray-400 capitalize font-bold self-start px-8 py-4 hover:text-white hover:bg-black">send message</button>
        </form>
