        ...
        <div class="flex flex-wrap items-center justify-center gap-8 px-10">
            <div class="flex flex-col items-start justify-center basis-80 gap-1 grow">
                ...
                <input type="text" name="name" required value="{{ old('name') }}"
                    class="placeholder:capitalize w-full p-2 rounded bg-gray outline-none @error('name') border-2 border-red-500 @enderror"
            ...
            <div class="flex flex-col items-start justify-center basis-80 gap-1 grow">
                ...
                <input type="text" name="username" required value="{{ old('username') }}"
                    class="placeholder:capitalize w-full p-2 rounded bg-gray outline-none @error('username') border-2 border-red-500 @enderror"
            ...
            <div class="flex flex-col items-start justify-center basis-80 gap-1 grow">
                ...
                <input type="password" name="password_confirmation" required
                    class="placeholder:capitalize w-full p-2 rounded bg-gray outline-none @error('password_confirmation') border-2 border-red-500 @enderror"
                    placeholder="repeat your password" />
            </div>
        </div>
        <button
            class="px-8 py-2 uppecase font-bold border-2 w-56 self-center uppercase rounded-full text-gray-400 hover:bg-black hover:text-white">register</button>
        <a href="{{ route('login.index') }}" class="text-gray-600 font-thinbold">Having an account? <span
