...
@section('content')
    <form action="{{ route('signup') }}" method="post" class="w-full md:w-3/4 bg-gray-50 p-4 self-center flex flex-col gap-8">
        @csrf
        ...
        <button
            class="px-8 py-2 uppecase font-bold border-2 w-56 self-center uppercase rounded-full text-gray-400 hover:bg-gray-400 hover:text-white">signup</button>
        <a href="{{ route('signin') }}" class="text-gray-600 font-thinbold">Having an account? <span
